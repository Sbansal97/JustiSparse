...
parser = argparse.ArgumentParser(description="Extrinsic Bias")
parser.add_argument(
    "--persistent_dir",
    action="store",
    type=str,
...
if __name__ == "__main__":
    ...
    model.load_adapter('/projects/tir6/general/srijanb/Spr23/JustiSparse/adapter-transformers/models/cda/gender/mlm')
