...
def main():
    ...
    parser = HfArgumentParser((ModelArguments, DataTrainingArguments, SftArguments, AdapterArguments, TrainingArguments, RegArguments))
    model_args, data_args, sft_args, adapter_args, training_args, reg_args = parser.parse_args_into_dataclasses()
