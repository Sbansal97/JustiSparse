...
CUDA_VISIBLE_DEVICES=4 bash train_extrinsic-debias_after.sh pfeiffer gab models/pfeiffer/cda/group/gab/mlm/ label cda &
...
CUDA_VISIBLE_DEVICES=7 bash train_extrinsic-debias_before.sh pfeiffer gab models/pfeiffer/cda/group/gab/mlm/ label cda &
...
# CUDA_VISIBLE_DEVICES=1 bash train_extrinsic-no_debias.sh pfeiffer gab models/pfeiffer/cda/group/gab/mlm/ label cda &
