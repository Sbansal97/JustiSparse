...
CUDA_VISIBLE_DEVICES=6 bash train_extrinsic-debias_before.sh pfeiffer gab models/pfeiffer/cda/group/gab/mlm/ label cda
...
CUDA_VISIBLE_DEVICES=0 bash train_extrinsic-debias_before.sh lora fdcl models/lora/adv/dialect/fdcl/class/ ND_label adv
